...
official_sources:
  ...
  - https://docs.newapi.pro/zh/docs/guide/feature-guide/admin/group
  - https://github.com/QuantumNous/new-api/tree/1721144221ec5c94dd87891a7ae1bee228e7bb63
  - https://github.com/QuantumNous/new-api/blob/1721144221ec5c94dd87891a7ae1bee228e7bb63/model/ability.go
  - https://github.com/QuantumNous/new-api/blob/1721144221ec5c94dd87891a7ae1bee228e7bb63/model/channel_cache.go
  - https://github.com/QuantumNous/new-api/blob/1721144221ec5c94dd87891a7ae1bee228e7bb63/model/channel.go
  - https://github.com/QuantumNous/new-api/blob/1721144221ec5c94dd87891a7ae1bee228e7bb63/service/channel_select.go
  - https://github.com/QuantumNous/new-api/blob/1721144221ec5c94dd87891a7ae1bee228e7bb63/controller/relay.go
  - https://github.com/QuantumNous/new-api/blob/1721144221ec5c94dd87891a7ae1bee228e7bb63/service/channel.go
  - https://github.com/QuantumNous/new-api/blob/1721144221ec5c94dd87891a7ae1bee228e7bb63/controller/channel-test.go
---
...
当前请求是否继续由重试策略单独判定。若错误允许重试且仍有次数，下一轮按较低优先级索引选择 C，而不是回到 A、B 同层“换一条再试”。若错误带 skip-retry、绑定了指定渠道，或预算耗尽，请求终止。
...
relay 在每轮重新选渠道并重新设置请求体，成功立即返回。失败后先记录和处理渠道错误，再由 `shouldRetry` 根据错误类型、skip-retry、剩余次数、指定渠道和状态码规则决定是否继续。
