...
test('orders section index links without rendering duplicate children', async () => {
  const expected = new Map([
    ['content/intro.mdx', 1],
    ['content/concepts/index.mdx', 2],
    ['content/principles/index.mdx', 3],
    ['content/quality-attributes/index.mdx', 4],
    ['content/methods/index.mdx', 5],
    ['content/modeling/index.mdx', 6],
    ['content/styles/index.mdx', 7],
    ['content/patterns/index.mdx', 8],
    ['content/cases/index.mdx', 9],
    ['content/questions/index.mdx', 10],
    ['content/paths/index.mdx', 11],
    ['content/references/index.mdx', 12],
  ]);
